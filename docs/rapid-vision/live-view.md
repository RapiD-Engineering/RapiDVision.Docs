...
**Live View** is the screen RapiD Vision opens to by default (the **Home** item in the navigation menu). It shows a live tile for every vision system currently connected to the client.
