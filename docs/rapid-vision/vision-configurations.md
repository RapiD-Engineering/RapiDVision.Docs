...
| Task Type | Use |
|---|---|
| **Classic** | Traditional (non-AI) blob/contour detection. Choose this if you want to use Filter Range/Erosion-based calibration, as described in [Camera Calibration](camera-calibration.md). |
